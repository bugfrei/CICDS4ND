					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CICD to S4 NoData",
									"targetURL": "#cicds4nd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cicds4nd-display": {
								"semanticObject": "cicds4nd",
								"action": "display",
								"description": "CICD to S4 System, ohne Datenanbindung",
								"title": "CICD to S4 NoData",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cicds4nd",
									"url": sap.ui.require.toUrl("cicds4nd")
								}
							}
						}
					}
